...
public class ImportDialogfragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        csvA = new File(requireContext().getExternalFilesDir(null), "import" + File.separator + "accounts");
        csvT = new File(requireContext().getExternalFilesDir(null), "import" + File.separator + "transactions");
        if (csvC.exists()) {
